...
type User struct {
	...
	Avatar          string `protobuf:"bytes,6,opt,name=avatar,proto3" json:"avatar,omitempty" form:"avatar" query:"avatar"`                                                              // 用户头像路径
	BackgroundImage string `protobuf:"bytes,7,opt,name=background_image,json=backgroundImage,proto3" json:"background_image,omitempty" form:"background_image" query:"background_image"` // 用户个人页页部大图
	Signature       string `protobuf:"bytes,8,opt,name=signature,proto3" json:"signature,omitempty" form:"signature" query:"signature"`                                                  // 个人简介
	TotalFavorited  string `protobuf:"bytes,9,opt,name=total_favorited,json=totalFavorited,proto3" json:"total_favorited,omitempty" form:"total_favorited" query:"total_favorited"`      // 获赞数量
	WorkCount       int64  `protobuf:"varint,10,opt,name=work_count,json=workCount,proto3" json:"work_count,omitempty" form:"work_count" query:"work_count"`                             // 作品数
	FavoriteCount   int64  `protobuf:"varint,11,opt,name=favorite_count,json=favoriteCount,proto3" json:"favorite_count,omitempty" form:"favorite_count" query:"favorite_count"`         // 喜欢数
}
...
var file_video_proto_rawDesc = []byte{
	...
	0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x74,
	...
	0x75, 0x6e, 0x74, 0x22, 0xf7, 0x01, 0x0a, 0x05, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x12, 0x0e, 0x0a,
	...
	0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x22, 0x5c, 0x0a,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x22, 0x5d, 0x0a, 0x1b, 0x44,
	...
	0x09, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x4d, 0x73, 0x67, 0x22, 0x49, 0x0a, 0x18, 0x44, 0x6f,
	...
	0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x88, 0x01, 0x0a, 0x19, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e,
	...
	0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x2e,
	...
	0x01, 0x28, 0x03, 0x52, 0x08, 0x6e, 0x65, 0x78, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x6f, 0x0a,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x89, 0x01, 0x0a, 0x1a, 0x44,
	...
	0x65, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x32, 0xc1, 0x02, 0x0a, 0x0c, 0x56, 0x69, 0x64, 0x65, 0x6f,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x71, 0x0a, 0x0c, 0x56, 0x69, 0x64, 0x65, 0x6f,
	0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x12, 0x21, 0x2e, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x2e,
	0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x41, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x22, 0x2e, 0x76, 0x69, 0x64,
	0x65, 0x6f, 0x2e, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68,
	...
	,
...
var file_video_proto_goTypes = []interface{}{
	...
	(*DouyinPublishActionRequest)(nil),   // 2: video.DouyinPublishActionRequest
	(*DouyinPublishActionResponse)(nil),  // 3: video.DouyinPublishActionResponse
	(*DouyinPublishListRequest)(nil),     // 4: video.DouyinPublishListRequest
	(*DouyinPublishListResponse)(nil),    // 5: video.DouyinPublishListResponse
	(*DouyinFeedRequest)(nil),            // 6: video.DouyinFeedRequest
	(*DouyinFeedResponse)(nil),           // 7: video.DouyinFeedResponse
	(*DouyinFavoriteActionRequest)(nil),  // 8: video.DouyinFavoriteActionRequest
	(*DouyinFavoriteActionResponse)(nil), // 9: video.DouyinFavoriteActionResponse
	(*DouyinFavoriteListRequest)(nil),    // 10: video.DouyinFavoriteListRequest
	(*DouyinFavoriteListResponse)(nil),   // 11: video.DouyinFavoriteListResponse
}
var file_video_proto_depIdxs = []int32{
	0, // 0: video.Video.author:type_name -> video.User
	1, // 1: video.DouyinPublishListResponse.video_list:type_name -> video.Video
	1, // 2: video.DouyinFeedResponse.video_list:type_name -> video.Video
	1, // 3: video.DouyinFavoriteListResponse.video_list:type_name -> video.Video
	2, // 4: video.VideoService.VideoPublish:input_type -> video.DouyinPublishActionRequest
	4, // 5: video.VideoService.GetPublishList:input_type -> video.DouyinPublishListRequest
	6, // 6: video.VideoService.GetFeed:input_type -> video.DouyinFeedRequest
	3, // 7: video.VideoService.VideoPublish:output_type -> video.DouyinPublishActionResponse
	4, // 8: video.VideoService.GetPublishList:output_type -> video.DouyinPublishListRequest
	7, // 9: video.VideoService.GetFeed:output_type -> video.DouyinFeedResponse
