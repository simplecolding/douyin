...
type userAuth struct {
	...
	FollowCount     field.Int64  // 关注人数
	FollowerCount   field.String // 粉丝总数
	IsFollow        field.Bool   // 是否关注，true-已关注，false-未关注
	Avatar          field.String // 用户头像
	BackgroundImage field.String // 用户个人页顶部大图
	Signature       field.String // 个人简介
	TotalFavorite   field.String // 获赞数量
...
func (u userAuthDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) IUserAuthDo {
